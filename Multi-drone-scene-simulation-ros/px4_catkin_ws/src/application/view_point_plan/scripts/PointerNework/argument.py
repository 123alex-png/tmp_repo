...
def argparser():
    ...
    parser.add_argument("--mode",
                        type=str,
                        default="train",
                        help="运行模式[train, train_emv, test]")
    parser.add_argument("--target_point_num",
                        type=int,
                        default=20,
    ...
    parser.add_argument("--num_samples",
                        ...
                        default=3,
                        help="number of episode")
    parser.add_argument("--use_rrt",
                        type=bool,
                        default=False,
                        help=" use rrt to path plan")
    # 训练参数
    ...
    parser.add_argument("--batch_size",
                        type=int,
                        default=512,
                        help="同一时刻优化的episode数")  # default=1024
    ...
    parser.add_argument('--islogger',
                        action='store_false',
                        help='flag csv logger default true')
    parser.add_argument('--issaver',
                        action='store_false',
                        help='flag model saver default true')
