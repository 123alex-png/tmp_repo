...
from RRT_star_bid_h.rrt_star import RRTStar
...
class RRTStarBidirectional(RRTStar):
    ...
    def connect_trees(self, a, b, x_new, L_near):
        ...
        for c_near, x_near in L_near:
            ...
            if c_tent < self.c_best and self.X.collision_free(
                    x_near, x_new, self.r):
    ...
    def unswap(self):
        ...
        if self.sigma_best is not None and self.sigma_best[
                0] is not self.x_init:
